...
$productIds[] = DB::table('products')->insertGetId(['name' => 'Smartphone XZ Pro', 'code' => 'EL-001', 'category_id' => $categoryIds[0], 'shipment_id' => $shipmentIds[0], 'price' => 15999, 'cost' => 12000, 'original_quantity' => 50, 'actual_quantity' => 45, 'total_cost' => 600000, 'tax' => 21, 'barcode' => '8594001', 'expired_date' => now()->addDays(315), 'created_at' => now(), 'updated_at' => now()]);
$productIds[] = DB::table('products')->insertGetId(['name' => 'Wireless Headphones', 'code' => 'EL-002', 'category_id' => $categoryIds[0], 'shipment_id' => $shipmentIds[0], 'price' => 2499, 'cost' => 1800, 'original_quantity' => 100, 'actual_quantity' => 85, 'total_cost' => 180000, 'tax' => 21, 'barcode' => '8594002', 'expired_date' => now()->addDays(315), 'created_at' => now(), 'updated_at' => now()]);
$productIds[] = DB::table('products')->insertGetId(['name' => 'Laptop 15.6"', 'code' => 'EL-003', 'category_id' => $categoryIds[0], 'shipment_id' => $shipmentIds[1], 'price' => 25999, 'cost' => 20000, 'original_quantity' => 30, 'actual_quantity' => 28, 'total_cost' => 600000, 'tax' => 21, 'barcode' => '8594003', 'expired_date' => now()->addDays(325), 'created_at' => now(), 'updated_at' => now()]);
$productIds[] = DB::table('products')->insertGetId(['name' => 'Wireless Mouse', 'code' => 'EL-004', 'category_id' => $categoryIds[0], 'shipment_id' => $shipmentIds[0], 'price' => 599, 'cost' => 350, 'original_quantity' => 200, 'actual_quantity' => 180, 'total_cost' => 70000, 'tax' => 21, 'barcode' => '8594004', 'expired_date' => now()->addDays(315), 'created_at' => now(), 'updated_at' => now()]);
$productIds[] = DB::table('products')->insertGetId(['name' => 'Mechanical Keyboard', 'code' => 'EL-005', 'category_id' => $categoryIds[0], 'shipment_id' => $shipmentIds[1], 'price' => 1999, 'cost' => 1400, 'original_quantity' => 80, 'actual_quantity' => 75, 'total_cost' => 112000, 'tax' => 21, 'barcode' => '8594005', 'expired_date' => now()->addDays(325), 'created_at' => now(), 'updated_at' => now()]);
$productIds[] = DB::table('products')->insertGetId(['name' => 'USB-C Hub 7-in-1', 'code' => 'EL-006', 'category_id' => $categoryIds[0], 'shipment_id' => $shipmentIds[1], 'price' => 899, 'cost' => 600, 'original_quantity' => 120, 'actual_quantity' => 110, 'total_cost' => 72000, 'tax' => 21, 'barcode' => '8594006', 'expired_date' => now()->addDays(325), 'created_at' => now(), 'updated_at' => now()]);
$productIds[] = DB::table('products')->insertGetId(['name' => 'Power Bank 20000mAh', 'code' => 'EL-007', 'category_id' => $categoryIds[0], 'shipment_id' => $shipmentIds[2], 'price' => 1299, 'cost' => 900, 'original_quantity' => 150, 'actual_quantity' => 140, 'total_cost' => 135000, 'tax' => 21, 'barcode' => '8594007', 'expired_date' => now()->addDays(335), 'created_at' => now(), 'updated_at' => now()]);
$productIds[] = DB::table('products')->insertGetId(['name' => 'Smart Watch Series 5', 'code' => 'EL-008', 'category_id' => $categoryIds[0], 'shipment_id' => $shipmentIds[2], 'price' => 7999, 'cost' => 6000, 'original_quantity' => 60, 'actual_quantity' => 55, 'total_cost' => 360000, 'tax' => 21, 'barcode' => '8594008', 'expired_date' => now()->addDays(335), 'created_at' => now(), 'updated_at' => now()]);
$productIds[] = DB::table('products')->insertGetId(['name' => 'Bluetooth Speaker', 'code' => 'EL-009', 'category_id' => $categoryIds[0], 'shipment_id' => $shipmentIds[2], 'price' => 1799, 'cost' => 1200, 'original_quantity' => 100, 'actual_quantity' => 90, 'total_cost' => 120000, 'tax' => 21, 'barcode' => '8594009', 'expired_date' => now()->addDays(335), 'created_at' => now(), 'updated_at' => now()]);
$productIds[] = DB::table('products')->insertGetId(['name' => '4K Webcam', 'code' => 'EL-010', 'category_id' => $categoryIds[0], 'shipment_id' => $shipmentIds[3], 'price' => 2999, 'cost' => 2200, 'original_quantity' => 70, 'actual_quantity' => 65, 'total_cost' => 154000, 'tax' => 21, 'barcode' => '8594010', 'expired_date' => now()->addDays(345), 'created_at' => now(), 'updated_at' => now()]);

// Clothing (10 products)
$productIds[] = DB::table('products')->insertGetId(['name' => 'Cotton T-Shirt', 'code' => 'CL-001', 'category_id' => $categoryIds[1], 'shipment_id' => $shipmentIds[0], 'price' => 499, 'cost' => 250, 'original_quantity' => 200, 'actual_quantity' => 180, 'total_cost' => 50000, 'tax' => 21, 'barcode' => '8594011', 'expired_date' => now()->addDays(315), 'created_at' => now(), 'updated_at' => now()]);
$productIds[] = DB::table('products')->insertGetId(['name' => 'Denim Jeans', 'code' => 'CL-002', 'category_id' => $categoryIds[1], 'shipment_id' => $shipmentIds[1], 'price' => 1299, 'cost' => 800, 'original_quantity' => 150, 'actual_quantity' => 140, 'total_cost' => 120000, 'tax' => 21, 'barcode' => '8594012', 'expired_date' => now()->addDays(325), 'created_at' => now(), 'updated_at' => now()]);
$productIds[] = DB::table('products')->insertGetId(['name' => 'Winter Jacket', 'code' => 'CL-003', 'category_id' => $categoryIds[1], 'shipment_id' => $shipmentIds[0], 'price' => 3999, 'cost' => 2800, 'original_quantity' => 80, 'actual_quantity' => 75, 'total_cost' => 224000, 'tax' => 21, 'barcode' => '8594013', 'expired_date' => now()->addDays(315), 'created_at' => now(), 'updated_at' => now()]);
$productIds[] = DB::table('products')->insertGetId(['name' => 'Hoodie Premium', 'code' => 'CL-004', 'category_id' => $categoryIds[1], 'shipment_id' => $shipmentIds[1], 'price' => 1599, 'cost' => 1000, 'original_quantity' => 120, 'actual_quantity' => 110, 'total_cost' => 120000, 'tax' => 21, 'barcode' => '8594014', 'expired_date' => now()->addDays(325), 'created_at' => now(), 'updated_at' => now()]);
$productIds[] = DB::table('products')->insertGetId(['name' => 'Dress Shirt', 'code' => 'CL-005', 'category_id' => $categoryIds[1], 'shipment_id' => $shipmentIds[1], 'price' => 899, 'cost' => 550, 'original_quantity' => 100, 'actual_quantity' => 95, 'total_cost' => 55000, 'tax' => 21, 'barcode' => '8594015', 'expired_date' => now()->addDays(325), 'created_at' => now(), 'updated_at' => now()]);
$productIds[] = DB::table('products')->insertGetId(['name' => 'Summer Dress', 'code' => 'CL-006', 'category_id' => $categoryIds[1], 'shipment_id' => $shipmentIds[2], 'price' => 1199, 'cost' => 750, 'original_quantity' => 90, 'actual_quantity' => 85, 'total_cost' => 67500, 'tax' => 21, 'barcode' => '8594016', 'expired_date' => now()->addDays(335), 'created_at' => now(), 'updated_at' => now()]);
$productIds[] = DB::table('products')->insertGetId(['name' => 'Leather Belt', 'code' => 'CL-007', 'category_id' => $categoryIds[1], 'shipment_id' => $shipmentIds[2], 'price' => 699, 'cost' => 400, 'original_quantity' => 150, 'actual_quantity' => 140, 'total_cost' => 60000, 'tax' => 21, 'barcode' => '8594017', 'expired_date' => now()->addDays(335), 'created_at' => now(), 'updated_at' => now()]);
$productIds[] = DB::table('products')->insertGetId(['name' => 'Baseball Cap', 'code' => 'CL-008', 'category_id' => $categoryIds[1], 'shipment_id' => $shipmentIds[3], 'price' => 399, 'cost' => 200, 'original_quantity' => 180, 'actual_quantity' => 170, 'total_cost' => 36000, 'tax' => 21, 'barcode' => '8594018', 'expired_date' => now()->addDays(345), 'created_at' => now(), 'updated_at' => now()]);
$productIds[] = DB::table('products')->insertGetId(['name' => 'Wool Scarf', 'code' => 'CL-009', 'category_id' => $categoryIds[1], 'shipment_id' => $shipmentIds[3], 'price' => 599, 'cost' => 350, 'original_quantity' => 120, 'actual_quantity' => 115, 'total_cost' => 42000, 'tax' => 21, 'barcode' => '8594019', 'expired_date' => now()->addDays(345), 'created_at' => now(), 'updated_at' => now()]);
$productIds[] = DB::table('products')->insertGetId(['name' => 'Sports Socks 3-Pack', 'code' => 'CL-010', 'category_id' => $categoryIds[1], 'shipment_id' => $shipmentIds[3], 'price' => 299, 'cost' => 150, 'original_quantity' => 250, 'actual_quantity' => 240, 'total_cost' => 37500, 'tax' => 21, 'barcode' => '8594020', 'expired_date' => now()->addDays(345), 'created_at' => now(), 'updated_at' => now()]);

// Food & Beverages (8 products)
$productIds[] = DB::table('products')->insertGetId(['name' => 'Coffee Beans 1kg', 'code' => 'FB-001', 'category_id' => $categoryIds[2], 'shipment_id' => $shipmentIds[0], 'price' => 399, 'cost' => 250, 'original_quantity' => 500, 'actual_quantity' => 450, 'total_cost' => 125000, 'tax' => 15, 'barcode' => '8594021', 'expired_date' => now()->addDays(315), 'created_at' => now(), 'updated_at' => now()]);
$productIds[] = DB::table('products')->insertGetId(['name' => 'Green Tea Box', 'code' => 'FB-002', 'category_id' => $categoryIds[2], 'shipment_id' => $shipmentIds[0], 'price' => 299, 'cost' => 180, 'original_quantity' => 300, 'actual_quantity' => 280, 'total_cost' => 54000, 'tax' => 15, 'barcode' => '8594022', 'expired_date' => now()->addDays(315), 'created_at' => now(), 'updated_at' => now()]);
$productIds[] = DB::table('products')->insertGetId(['name' => 'Organic Honey 500g', 'code' => 'FB-003', 'category_id' => $categoryIds[2], 'shipment_id' => $shipmentIds[1], 'price' => 249, 'cost' => 150, 'original_quantity' => 200, 'actual_quantity' => 190, 'total_cost' => 30000, 'tax' => 15, 'barcode' => '8594023', 'expired_date' => now()->addDays(325), 'created_at' => now(), 'updated_at' => now()]);
$productIds[] = DB::table('products')->insertGetId(['name' => 'Chocolate Bar Premium', 'code' => 'FB-004', 'category_id' => $categoryIds[2], 'shipment_id' => $shipmentIds[1], 'price' => 89, 'cost' => 50, 'original_quantity' => 600, 'actual_quantity' => 580, 'total_cost' => 30000, 'tax' => 15, 'barcode' => '8594024', 'expired_date' => now()->addDays(325), 'created_at' => now(), 'updated_at' => now()]);
$productIds[] = DB::table('products')->insertGetId(['name' => 'Energy Drink 24-pack', 'code' => 'FB-005', 'category_id' => $categoryIds[2], 'shipment_id' => $shipmentIds[2], 'price' => 599, 'cost' => 400, 'original_quantity' => 150, 'actual_quantity' => 140, 'total_cost' => 60000, 'tax' => 21, 'barcode' => '8594025', 'expired_date' => now()->addDays(335), 'created_at' => now(), 'updated_at' => now()]);
$productIds[] = DB::table('products')->insertGetId(['name' => 'Mineral Water 6-pack', 'code' => 'FB-006', 'category_id' => $categoryIds[2], 'shipment_id' => $shipmentIds[2], 'price' => 149, 'cost' => 90, 'original_quantity' => 400, 'actual_quantity' => 380, 'total_cost' => 36000, 'tax' => 15, 'barcode' => '8594026', 'expired_date' => now()->addDays(335), 'created_at' => now(), 'updated_at' => now()]);
$productIds[] = DB::table('products')->insertGetId(['name' => 'Protein Bar Box', 'code' => 'FB-007', 'category_id' => $categoryIds[2], 'shipment_id' => $shipmentIds[3], 'price' => 449, 'cost' => 300, 'original_quantity' => 250, 'actual_quantity' => 240, 'total_cost' => 75000, 'tax' => 15, 'barcode' => '8594027', 'expired_date' => now()->addDays(345), 'created_at' => now(), 'updated_at' => now()]);
$productIds[] = DB::table('products')->insertGetId(['name' => 'Olive Oil 1L', 'code' => 'FB-008', 'category_id' => $categoryIds[2], 'shipment_id' => $shipmentIds[3], 'price' => 349, 'cost' => 220, 'original_quantity' => 180, 'actual_quantity' => 170, 'total_cost' => 39600, 'tax' => 15, 'barcode' => '8594028', 'expired_date' => now()->addDays(345), 'created_at' => now(), 'updated_at' => now()]);

// Home & Garden (5 products - simplified)
$productIds[] = DB::table('products')->insertGetId(['name' => 'LED Light Bulbs', 'code' => 'HG-001', 'category_id' => $categoryIds[3], 'shipment_id' => $shipmentIds[1], 'price' => 599, 'cost' => 350, 'original_quantity' => 250, 'actual_quantity' => 240, 'total_cost' => 87500, 'tax' => 21, 'barcode' => '8594029', 'expired_date' => now()->addDays(325), 'created_at' => now(), 'updated_at' => now()]);
$productIds[] = DB::table('products')->insertGetId(['name' => 'Garden Tool Set', 'code' => 'HG-002', 'category_id' => $categoryIds[3], 'shipment_id' => $shipmentIds[2], 'price' => 1999, 'cost' => 1200, 'original_quantity' => 80, 'actual_quantity' => 75, 'total_cost' => 96000, 'tax' => 21, 'barcode' => '8594030', 'expired_date' => now()->addDays(335), 'created_at' => now(), 'updated_at' => now()]);
$productIds[] = DB::table('products')->insertGetId(['name' => 'Towel Set 4-piece', 'code' => 'HG-003', 'category_id' => $categoryIds[3], 'shipment_id' => $shipmentIds[3], 'price' => 899, 'cost' => 550, 'original_quantity' => 120, 'actual_quantity' => 110, 'total_cost' => 66000, 'tax' => 21, 'barcode' => '8594031', 'expired_date' => now()->addDays(345), 'created_at' => now(), 'updated_at' => now()]);
$productIds[] = DB::table('products')->insertGetId(['name' => 'Storage Basket Set', 'code' => 'HG-004', 'category_id' => $categoryIds[3], 'shipment_id' => $shipmentIds[3], 'price' => 699, 'cost' => 400, 'original_quantity' => 150, 'actual_quantity' => 145, 'total_cost' => 60000, 'tax' => 21, 'barcode' => '8594032', 'expired_date' => now()->addDays(345), 'created_at' => now(), 'updated_at' => now()]);
$productIds[] = DB::table('products')->insertGetId(['name' => 'Wall Clock Modern', 'code' => 'HG-005', 'category_id' => $categoryIds[3], 'shipment_id' => $shipmentIds[4], 'price' => 999, 'cost' => 650, 'original_quantity' => 90, 'actual_quantity' => 85, 'total_cost' => 58500, 'tax' => 21, 'barcode' => '8594033', 'expired_date' => now()->addDays(352), 'created_at' => now(), 'updated_at' => now()]);

// Sports (5 products - simplified)
$productIds[] = DB::table('products')->insertGetId(['name' => 'Yoga Mat', 'code' => 'SO-001', 'category_id' => $categoryIds[4], 'shipment_id' => $shipmentIds[1], 'price' => 799, 'cost' => 500, 'original_quantity' => 150, 'actual_quantity' => 145, 'total_cost' => 75000, 'tax' => 21, 'barcode' => '8594034', 'expired_date' => now()->addDays(325), 'created_at' => now(), 'updated_at' => now()]);
$productIds[] = DB::table('products')->insertGetId(['name' => 'Running Shoes', 'code' => 'SO-002', 'category_id' => $categoryIds[4], 'shipment_id' => $shipmentIds[1], 'price' => 2499, 'cost' => 1600, 'original_quantity' => 120, 'actual_quantity' => 115, 'total_cost' => 192000, 'tax' => 21, 'barcode' => '8594035', 'expired_date' => now()->addDays(325), 'created_at' => now(), 'updated_at' => now()]);
$productIds[] = DB::table('products')->insertGetId(['name' => 'Dumbbell Set 20kg', 'code' => 'SO-003', 'category_id' => $categoryIds[4], 'shipment_id' => $shipmentIds[2], 'price' => 1899, 'cost' => 1300, 'original_quantity' => 60, 'actual_quantity' => 55, 'total_cost' => 78000, 'tax' => 21, 'barcode' => '8594036', 'expired_date' => now()->addDays(335), 'created_at' => now(), 'updated_at' => now()]);
$productIds[] = DB::table('products')->insertGetId(['name' => 'Water Bottle 1L', 'code' => 'SO-004', 'category_id' => $categoryIds[4], 'shipment_id' => $shipmentIds[3], 'price' => 299, 'cost' => 180, 'original_quantity' => 300, 'actual_quantity' => 290, 'total_cost' => 54000, 'tax' => 21, 'barcode' => '8594037', 'expired_date' => now()->addDays(345), 'created_at' => now(), 'updated_at' => now()]);
$productIds[] = DB::table('products')->insertGetId(['name' => 'Gym Bag Premium', 'code' => 'SO-005', 'category_id' => $categoryIds[4], 'shipment_id' => $shipmentIds[4], 'price' => 1299, 'cost' => 850, 'original_quantity' => 100, 'actual_quantity' => 95, 'total_cost' => 85000, 'tax' => 21, 'barcode' => '8594038', 'expired_date' => now()->addDays(352), 'created_at' => now(), 'updated_at' => now()]);
