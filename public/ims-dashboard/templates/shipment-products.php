...
$shipment = fetchData("http://localhost/ims/public/api/shipments/$shipment_id");
$products = fetchData("http://localhost/ims/public/api/products"); // Full product list for adding products
$shipmentProducts = fetchData("http://localhost/ims/public/api/shipment-products/$shipment_id");
echo "<pre>";
